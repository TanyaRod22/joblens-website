    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="mx-auto max-w-3xl px-4 sm:px-6 py-16 prose prose-slate">
        ...
        <p className="mt-6 text-slate-700 leading-relaxed">
          This page is maintained by the Joblens team to answer common privacy questions
          about the Joblens Chrome extension. It describes the data we collect, why we
        ...
        <ul className="mt-3 space-y-2 text-slate-700">
          <li>
            The text of job postings you actively choose to scan by clicking
            "Scan Job".
          </li>
          <li>The resume content you upload to personalize your results.</li>
          <li>
            Basic usage events (e.g. scans completed) so we can improve the product.
          </li>
        </ul>

        <h2 className="mt-8 text-xl font-semibold text-slate-900">How we use it</h2>
        <p className="mt-3 text-slate-700 leading-relaxed">
          Job text and resume content are sent to our secure backend for AI analysis.
          Third-party AI provider API keys never leave our servers. We do not sell your
          data or share it with advertisers.
        </p>

        <h2 className="mt-8 text-xl font-semibold text-slate-900">Retention</h2>
        <p className="mt-3 text-slate-700 leading-relaxed">
          You can delete your uploaded resume from the extension at any time. Job scan
          history is retained only to support your own scan history view.
        </p>
